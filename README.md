...
The project was implemented using an ESP8266MOD microcontroller, LM35
temperature sensor, LEDs, and a Wi-Fi network.

![ESP8266 Hardware](images/esp8266-hardware.jpg)

---

## 🔄 Node-RED Fog Processing

Node-RED performs fog-level processing, threshold checking, alert
generation, and forwards processed data to InfluxDB.

![Node-RED Flow](images/node-red_dash-flow.jpeg)

![Node-RED Dashboard](images/node-red_dashboard.jpeg)

---

## 🗄️ InfluxDB Data Storage

InfluxDB is used for time-series storage of temperature and latency
...
Grafana provides visualization of temperature readings and the
fog-versus-cloud latency comparison.

![Grafana Dashboard](images/grafana.jpeg)

---

## 🔔 Alert and Processing

The system uses threshold-based processing to generate alerts and
control the local LED indicators.

![Node-RED Alert](images/node-red_alert.jpeg)
